...
registerBlockType('gpersiandate/compact', {
  ...
  keywords: [_x('compact', 'Blocks', 'gpersiandate'), _x('monthly', 'Blocks', 'gpersiandate'), _x('archive', 'Blocks', 'gpersiandate')],
  category: 'widgets',
  icon: 'archive',
  supports: {
  ...
  edit: function edit(props) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(ServerSideRender, {
      ...
      attributes: props.attributes // className={props.className}
